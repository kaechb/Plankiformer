...
predpath=$(printf ${folderpath})
cd /users/bkch/Plankiformer_OOD

python predict.py -test_path $filepath  -test_outpath $predpath -main_param_path /scratch/snx3000/sdennis/eco_pomati/Plankiformer_OOD/trained_BEiT_models_Zoo/ -model_path /scratch/snx3000/sdennis/eco_pomati/Plankiformer_OOD/trained_BEiT_models_Zoo/trained_models/01/ /scratch/snx3000/sdennis/eco_pomati/Plankiformer_OOD/trained_BEiT_models_Zoo/trained_models/02/ /scratch/snx3000/sdennis/eco_pomati/Plankiformer_OOD/trained_BEiT_models_Zoo/trained_models/03/ -ensemble 2 -finetuned 1 -threshold 0.0 -resize_images 1 -use_gpu yes -TTA yes
