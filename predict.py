...
if __name__ == '__main__':
    ...
    test_data = create_data.CreateDataset(   args.test_path, model_params.L, args.resize_images, args.TTA)
    ...
    # Do Predictions
    model_training.load_model_and_run_prediction(model_params,args, test_data)
